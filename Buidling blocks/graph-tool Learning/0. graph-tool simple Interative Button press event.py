...
# see all types of variable here https://graph-tool.skewed.de/static/doc/graph_tool.html#graph_tool.PropertyMap
...
#                   vertex_halo_color=vHaloColor,
#                   vertex_fill_color=vcolor, vertex_text=g.vertex_index,
#                   vertex_font_size=18, geometry=(1000, 800))
...
win = GraphWindow(g, pos,
                  ...
                  vertex_font_size=18,
                   vertex_halo_size = 0.0,  # this is temporary method to remove halos, which are formed when a node is mouse hovered  
                    geometry=(1000, 800))
...
def update_bfs(widget, event):
    ...
    widget.queue_draw()
    # win.graph.connect("button-press-event", update_bfs)
